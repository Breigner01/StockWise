...
import { addInventory, decreaseInventory, storeInventory } from "../../redux/actions/inventoryActions";
...
export default connect(mapStateToProps, { addInventory, decreaseInventory, storeInventory })(UpdateInventoryForm);