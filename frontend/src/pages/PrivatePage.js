...
import { getInventory, addInventory, decreaseInventory } from "../redux/actions/inventoryActions";
...
const PrivatePage = (props) => {
    ...
    const handleAddInventory = (e) => {
        ...
        props.addInventory("abc123", invData);
    };
    ...
    const handleDecreaseInventory = (e) => {
        ...
        props.decreaseInventory("abc123", invData);
    };
        ...
        <Grid container spacing={1} >
            <Grid item xs={12}>
                <header className="App-header">
                    ...
                    <Box component="form" onSubmit={handleDecreaseInventory} sx={{ mt: 1 }}>
                        <Button
                            type="submit"
                            fullWidth
                            variant="contained"
...
export default connect(mapStateToProps, {
    ...
    getInventory, addInventory, decreaseInventory
})(PrivatePage);
